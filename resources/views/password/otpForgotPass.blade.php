...
<body>
	...
	<div class="login-content">
        ...
        <div class="alert alert-info">{{ Cache::get('otp_expires_time') }}</div>
       
		<form method="post" action="{{URL('/confirmFotgot.html')}}" id="forgotPasswordForm">
            <input type="hidden" name="_token" value="{{ csrf_token() }}" />
            <div class="form-group">
                <input type="text" class="user" name="OTPForgot" id="otpForgotPassword" placeholder="Nhập OTP của bạn" required="required" />
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/react/17.0.1/umd/react.production.min.js">
    ...
    Validator({
            ...
            rules: [
                Validator.isRequired('#otpForgotPassword','Vui lòng không để trống tên'),    
                Validator.isNumber('#otpForgotPassword','Vui lòng nhập số'),   
                Validator.isMaxlength('#otpForgotPassword',6,'Không quá 6 ký tự'),  
