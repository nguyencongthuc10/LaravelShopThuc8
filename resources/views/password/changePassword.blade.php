	...
	<div class="login-content">
		...
		<form method="post" action="{{URL('/changePass.html')}}" id="forgotPasswordForm">
            ...
            <div class="form-group">
                <input type="password" class="user" name="changePassOTP" id="changePassOTP" placeholder="Nhập mật khẩu mới của bạn" required="required" />
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/react/17.0.1/umd/react.production.min.js">
    ...
    Validator({
            ...
            rules: [
                Validator.isRequired('#changePassOTP','Vui lòng không để trống'),       
                Validator.isMinlength('#changePassOTP',6,'Mậ khẩu không nhỏ hơn 6 ký tự'),  
